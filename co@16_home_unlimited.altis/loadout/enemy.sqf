private ["_unit", "_backpack", "_uniform"];
...
if (!isNull _unit) then {
    ...
    _listOfUniforms = ["U_Competitor", "U_C_Poor_1", "U_C_Poor_2", "U_Marshal", "U_C_WorkerCoveralls", "U_I_G_Story_Protagonist_F", "U_I_G_resistanceLeader_F", "U_NikosBody", "U_OrestesBody", "U_Rangemaster","U_C_HunterBody_grn","U_BG_Guerrilla_6_1","U_BG_Guerilla1_1","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_BG_Guerilla3_1","U_BG_leader"];
    
    if (isClass(configFile >> "CfgPatches" >> "mas_afr_rebl")) then
	{
        _masAfrConflictUniforms = ["U_mas_afr_O_rebel1","U_mas_afr_O_rebel2","U_mas_afr_O_rebel3","U_mas_afr_O_rebel4","U_mas_afr_O_rebel5","U_mas_afr_O_rebel6","U_mas_afr_O_rebel7","U_mas_afr_O_rebel8","U_mas_afr_O_rebel9","U_mas_afr_O_rebel10","U_mas_afr_O_uniform1","U_mas_afr_O_uniform2","U_mas_afr_O_uniform3","U_mas_afr_O_uniform4","U_mas_afr_O_uniform5","U_mas_afr_O_uniform6","U_mas_afr_O_uniform7","U_mas_afr_O_uniform8"];
        _listOfUniforms append _masAfrConflictUniforms;
    };
    
    if (isClass(configFile >> "CfgPatches" >> "rhs_main")) then
	{
        _rhsGuerUniforms = ["rhs_chdkz_uniform_1", "rhs_chdkz_uniform_2", "rhs_chdkz_uniform_3", "rhs_chdkz_uniform_4", "rhs_chdkz_uniform_5"];
    ...
    _haveHeadgear = [0,1,2] call bis_fnc_selectRandom;
    if (_haveHeadgear == 1) then
    {
        _listOfHeadgears = ["H_Bandanna_blu","H_Bandanna_gry","H_Bandanna_khk","H_Bandanna_sgg","H_Bandanna_sand","H_Beret_blk","H_Beret_grn","H_Beret_red","H_Booniehat_dirty","H_Booniehat_grn","H_Booniehat_indp","H_Booniehat_tan","H_Cap_blk","H_Cap_blu","H_Cap_grn","H_Cap_red","H_Cap_surfer","H_Cap_tan","H_Hat_blue","H_Hat_brown","H_Hat_checker","H_Hat_grey","H_Hat_tan","H_StrawHat","H_StrawHat_dark","H_Watchcap_blk","H_Watchcap_khk","H_Watchcap_sgg"];
	    if (isClass(configFile >> "CfgPatches" >> "rhs_main")) then
		{
    ...
    waitUntil { !( isNil {pht6_parameter_enemyArmor} )}; 
    
    switch (pht6_parameter_enemyArmor) do {
		case 0: {
    ...
    waitUntil 
    { 
		(!( isNil {pht6_parameter_enemyWeapPistols} )) AND
		(!( isNil {pht6_parameter_enemyWeapSmgs} )) AND
        (!( isNil {pht6_parameter_enemyWeapShotguns} )) AND
        (!( isNil {pht6_parameter_enemyWeapRifles} )) AND 
        (!( isNil {pht6_parameter_enemyFAK} )) AND 
        (!( isNil {pht6_parameter_enemyThrowableGrenades} )) AND 
        (!( isNil {pht6_parameter_enemyThrowableMiniGrenades} )) AND 
        (!( isNil {pht6_parameter_enemyThrowableSmokeGrenades} )) AND 
        (!( isNil {pht6_parameter_enemyThrowableChemLights} )) 
	}; 
    
    if (pht6_parameter_enemyWeapPistols == 1) then 
    {
    ...
    if (pht6_parameter_enemyWeapSmgs == 2) then 
    {
        _listVanillaSMGs = ["hgun_PDW2000_F", "SMG_01_F", "SMG_02_F"];
        _listOfWeapons append _listVanillaSMGs;
    };
    
    if (pht6_parameter_enemyWeapRifles == 1 OR pht6_parameter_enemyWeapRifles == 3) then
    {
    ...
    if (isClass(configFile >> "CfgPatches" >> "CUP_Weapons_WeaponsCore") && pht6_parameter_enemyWeapSmgs == 2) then
	{
        _listCUPSMGs = ["CUP_hgun_SA61","CUP_hgun_MicroUzi","CUP_smg_bizon","CUP_smg_EVO","CUP_smg_MP5A5"];
		_listOfWeapons append _listCUPSMGs;
	};
    
    if (isClass(configFile >> "CfgPatches" >> "CUP_Weapons_WeaponsCore") && pht6_parameter_enemyWeapShotguns == 2) then
	{
        _listCUPShotguns = ["CUP_sgun_AA12","CUP_sgun_M1014","CUP_sgun_Saiga12K"];
		_listOfWeapons append _listCUPShotguns;
	};
    
    if (isClass(configFile >> "CfgPatches" >> "CUP_Weapons_WeaponsCore") && pht6_parameter_enemyWeapShotguns == 1) then
	{
    ...
    if (isClass(configFile >> "CfgPatches" >> "CUP_Weapons_WeaponsCore") && (pht6_parameter_enemyWeapRifles == 2 OR pht6_parameter_enemyWeapRifles == 3)) then
	{
		_listOfWeapons pushBack "CUP_srifle_LeeEnfield";
	};
    
    if (isClass(configFile >> "CfgPatches" >> "fhq_m4_a3") && (pht6_parameter_enemyWeapRifles == 1 OR pht6_parameter_enemyWeapRifles == 3)) then
	{
	...
	if (isClass(configFile >> "CfgPatches" >> "rhsusf_main") && (pht6_parameter_enemyWeapShotguns == 1 OR pht6_parameter_enemyWeapShotguns == 2)) then
    {
    ...
    if (isClass(configFile >> "CfgPatches" >> "rhs_main") && pht6_parameter_enemyWeapPistols == 1) then
    {
    ...
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && pht6_parameter_enemyWeapSmgs == 2) then 
    {
    ...
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && pht6_parameter_enemyWeapShotguns == 2) then 
    {
    	_listMassiShotguns = ["arifle_mas_aa12","arifle_mas_m1014","arifle_mas_saiga"];
        _listOfWeapons append _listMassiShotguns;  
    };
    
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && pht6_parameter_enemyWeapShotguns == 1) then 
    {
    	_listMassiRegShotguns = ["arifle_mas_m1014","arifle_mas_saiga"];
        _listOfWeapons append _listMassiRegShotguns;  
    };
    
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && (pht6_parameter_enemyWeapRifles == 1 OR pht6_parameter_enemyWeapRifles == 3)) then 
    {
    ...
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && pht6_parameter_enemyWeapSmgs == 1) then 
    {
    	_listMassiOldSmgs = ["arifle_mas_mp40","arifle_mas_mp40_o","arifle_mas_sten"];
        _listOfWeapons append _listMassiOldSmgs;  
    };
    
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons") && (pht6_parameter_enemyWeapRifles == 2 OR pht6_parameter_enemyWeapRifles == 3)) then 
    {
        _listOfWeapons pushBack "arifle_mas_lee";  
    };
    
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_mp5") && pht6_parameter_enemyWeapSmgs == 2) then
	{
    ...
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_ak") && (pht6_parameter_enemyWeapShotguns == 1 OR pht6_parameter_enemyWeapShotguns == 2)) then
	{
		_listOfWeapons pushBack "hlc_rifle_saiga12k";
	};
    
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_ak") && (pht6_parameter_enemyWeapRifles == 1 OR pht6_parameter_enemyWeapRifles == 3)) then
	{
        _listHLCAKs = ["hlc_rifle_aks74u","hlc_rifle_ak47","hlc_rifle_akm","hlc_rifle_aku12"];
		_listOfWeapons append _listHLCAKs;
	};
    
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_AR15") && (pht6_parameter_enemyWeapRifles == 1 OR pht6_parameter_enemyWeapRifles == 3)) then
	{
    ...
    if (_randomWeapon == "hgun_ACPC2_F") then
    {
        ...
        _uniform addMagazineCargoGlobal ["9Rnd_45ACP_Mag", 8];
    };
    ...
    if (_randomWeapon == "hgun_P07_F" OR _randomWeapon == "hgun_Rook40_F") then
    {
        ...
        _unit addWeaponGlobal _randomWeapon;
        _uniform addMagazineCargoGlobal ["16Rnd_9x21_Mag", 8];
    };
    ...
    if (_randomWeapon == "hgun_Pistol_heavy_01_F") then
    {
        ...
        _unit addWeaponGlobal _randomWeapon;        
        _uniform addMagazineCargoGlobal ["11Rnd_45ACP_Mag", 8];
    };
    ...
    if (_randomWeapon == "hgun_Pistol_heavy_02_F") then
    {
        ...
        _unit addWeaponGlobal _randomWeapon;        
        _uniform addMagazineCargoGlobal ["6Rnd_45ACP_Cylinder", 8];
    };
    ...
    if (_randomWeapon == "hgun_PDW2000_F" OR _randomWeapon == "SMG_02_F") then
    {
        ...
        _uniform addMagazineCargoGlobal ["30Rnd_9x21_Mag", 7];
    };
    ...
    if (_randomWeapon == "SMG_01_F") then
    {
        ...
        _unit addWeaponGlobal _randomWeapon;        
        _uniform addMagazineCargoGlobal ["30Rnd_45ACP_Mag_SMG_01", 7];
    };
    ...
    if (_randomWeapon == "arifle_Katiba_C_F") then 
    {
        ...
        _unit addWeaponGlobal _randomWeapon;    	 
        _unit addPrimaryWeaponItem "acc_flashlight";
        _uniform addMagazineCargoGlobal ["30Rnd_65x39_caseless_green", 6];
    };
    ...
    if (_randomWeapon == "arifle_Mk20C_plain_F" OR _randomWeapon == "arifle_TRG21_F" OR _randomWeapon == "arifle_TRG20_F" OR _randomWeapon == "arifle_SDAR_F") then 
    {
        ...
        _unit addWeaponGlobal _randomWeapon;    	 
        _unit addPrimaryWeaponItem "acc_flashlight";
        _uniform addMagazineCargoGlobal ["30Rnd_556x45_Stanag", 6];
    };
    ...
    if (_randomWeapon == "arifle_MXC_F" OR _randomWeapon == "arifle_MXC_Black_F") then 
    {
        ...
        _unit addWeaponGlobal _randomWeapon;    	  
        _unit addPrimaryWeaponItem "acc_flashlight";
        _uniform addMagazineCargoGlobal ["30Rnd_65x39_caseless_mag", 6];
    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "CUP_Weapons_WeaponsCore")) then
    {
    	if (_randomWeapon == "CUP_hgun_Colt1911") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_7Rnd_45ACP_1911", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_Compact") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_10Rnd_9x19_Compact", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_Phantom_Flashlight") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_18Rnd_9x19_Phantom", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_glock17_flashlight") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;
	        _uniform addMagazineCargoGlobal ["CUP_17Rnd_9x19_glock17", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_M9") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_15Rnd_9x19_M9", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_Makarov" OR _randomWeapon == "CUP_hgun_PB6P9" OR _randomWeapon == "CUP_hgun_PB6P9_snds") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_8Rnd_9x18_Makarov_M", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_TaurusTracker455" OR _randomWeapon == "CUP_hgun_TaurusTracker455_gold") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	  
	        _uniform addMagazineCargoGlobal ["CUP_6Rnd_45ACP_M", 8];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_SA61") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_20Rnd_B_765x17_Ball_M", 7];
	    };
	    ...
	    if (_randomWeapon == "CUP_hgun_MicroUzi") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_9x19_UZI", 7];
	    };
	    ...
	    if (_randomWeapon == "CUP_smg_bizon") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["CUP_64Rnd_9x19_Bizon_M", 4];
	    };
	    ...
	    if (_randomWeapon == "CUP_smg_EVO") then
	    {
	        ...
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_9x19_EVO", 7];
	    };
	    ...
	    if (_randomWeapon == "CUP_smg_MP5A5") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_9x19_MP5", 7];
	    };
	    ...
	    if (_randomWeapon == "CUP_sgun_AA12") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["CUP_20Rnd_B_AA12_Pellets", 3];
	        _uniform addMagazineCargoGlobal ["CUP_20Rnd_B_AA12_74Slug", 2];
	    };
	    ...
	    if (_randomWeapon == "CUP_sgun_M1014") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["CUP_8Rnd_B_Beneli_74Pellets", 4];
	        _uniform addMagazineCargoGlobal ["CUP_8Rnd_B_Beneli_74Slug", 3];
	    };
	    ...
	    if (_randomWeapon == "CUP_sgun_Saiga12K") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["CUP_8Rnd_B_Saiga12_74Pellets_M", 4];
	        _uniform addMagazineCargoGlobal ["CUP_8Rnd_B_Saiga12_74Slug_M", 3];
	    };
	    ...
	    if (_randomWeapon == "CUP_arifle_AKS" OR _randomWeapon == "CUP_arifle_AKS_Gold") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_762x39_AK47_M", 6];
	    };
	    ...
	    if (_randomWeapon == "CUP_arifle_AKS74U") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_545x39_AK_M", 6];
	    };
	    ...
	    if (_randomWeapon == "CUP_arifle_Sa58V") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_30Rnd_Sa58_M", 6];
	    };
	    ...
	    if (_randomWeapon == "CUP_srifle_LeeEnfield") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["CUP_10x_303_M", 6];
	    };    
    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "rhsusf_main")) then 
    {
		...
		if (_randomWeapon == "rhs_weap_M590_8RD") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["rhsusf_8Rnd_00Buck", 4];
	        _uniform addMagazineCargoGlobal ["rhsusf_8Rnd_Slug", 3];
	    };
	    ...
	    if (_randomWeapon == "rhs_weap_M590_5RD") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["rhsusf_5Rnd_00Buck", 5];
	        _uniform addMagazineCargoGlobal ["rhsusf_5Rnd_Slug", 4];
	    };
	    ...
	    if (_randomWeapon == "RHSUSF_WEAP_GLOCK17G4") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["rhsusf_mag_17Rnd_9x19_FMJ", 4];
	        _uniform addMagazineCargoGlobal ["rhsusf_mag_17Rnd_9x19_JHP", 4];
	    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "rhs_main")) then 
    {
	    if (_randomWeapon == "rhs_weap_ak74m_folded") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["rhs_30Rnd_545x39_AK", 6];
	    };
	    ...
	    if (_randomWeapon == "rhs_weap_akms") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;
	        _uniform addMagazineCargoGlobal ["rhs_30Rnd_762x39mm", 6];
	    };
	    ...
	    if (_randomWeapon == "rhs_weap_pya") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;
	        _uniform addMagazineCargoGlobal ["rhs_mag_9x19_17", 8];
	    };
	    ...
	    if (_randomWeapon == "rhs_weap_makarov_pmm") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	
	        _uniform addMagazineCargoGlobal ["rhs_mag_9x18_12_57N181S", 8];
	    };  
    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "mas_weapons")) then 
    {
		if (_randomWeapon == "hgun_mas_acp_F") then
	    {
	        ...
	        _uniform addMagazineCargoGlobal ["8Rnd_mas_45acp_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_bhp_F" OR _randomWeapon == "hgun_mas_p226_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addHandgunItem "acc_mas_flash_gun";
	        _uniform addMagazineCargoGlobal ["13Rnd_mas_9x21_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_glock_F" OR _randomWeapon == "hgun_mas_grach_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addHandgunItem "acc_mas_flash_gun";
	        _uniform addMagazineCargoGlobal ["17Rnd_mas_9x21_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_m23_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addHandgunItem "acc_mas_flash_gun";
	        _uniform addMagazineCargoGlobal ["10Rnd_mas_45acp_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_m9_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addHandgunItem "acc_mas_flash_gun";
	        _uniform addMagazineCargoGlobal ["15Rnd_mas_9x21_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_mak_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["8Rnd_mas_9x18_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_usp_F" OR _randomWeapon == "hgun_mas_usp_l_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addHandgunItem "acc_mas_flash_gun";
	        _uniform addMagazineCargoGlobal ["12Rnd_mas_45acp_Mag", 8];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_bizon") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["64Rnd_mas_9x18_mag", 4];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_mp7_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["40Rnd_mas_46x30_Mag", 7];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_uzi_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["25Rnd_mas_9x19_Mag", 7];
	    };
	    ...
	    if (_randomWeapon == "hgun_mas_sa61_F") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["20Rnd_mas_765x17_Mag", 7];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_aa12") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["20Rnd_mas_12Gauge_Pellets", 3];
	        _uniform addMagazineCargoGlobal ["20Rnd_mas_12Gauge_Slug", 2];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_m1014") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["7Rnd_mas_12Gauge_Pellets", 4];
	        _uniform addMagazineCargoGlobal ["7Rnd_mas_12Gauge_Slug", 3];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_saiga") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["10Rnd_mas_12Gauge_Pellets", 4];
	        _uniform addMagazineCargoGlobal ["10Rnd_mas_12Gauge_Slug", 3];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_akms") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _uniform addMagazineCargoGlobal ["30Rnd_mas_762x39_mag", 6];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_aks74u" OR _randomWeapon == "arifle_mas_aks74u_c") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["30Rnd_mas_545x39_mag", 6];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_arx" OR _randomWeapon == "arifle_mas_g36c" OR _randomWeapon == "arifle_mas_hk416c" OR _randomWeapon == "arifle_mas_m4vlt" OR _randomWeapon == "arifle_mas_m4c" OR _randomWeapon == "arifle_mas_mk16") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["30Rnd_mas_556x45_Stanag", 6];
	    };
	    ...
	    if (_randomWeapon == "arifle_mas_lee") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["5Rnd_mas_762x51_Stanag", 11];
	    };    
    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_mp5")) then
    {
    	if (_randomWeapon == "hlc_smg_mp5k") then
	    {
	        ...
	        _uniform addMagazineCargoGlobal ["hlc_30Rnd_9x19_B_MP5", 7];
	    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_ak")) then 
    {
	    if (_randomWeapon == "hlc_rifle_saiga12k") then
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	        
	        _uniform addMagazineCargoGlobal ["hlc_10rnd_12g_buck_S12", 4];
	        _uniform addMagazineCargoGlobal ["hlc_10rnd_12g_slug_S12", 3];
	    };
	    ...
	    if (_randomWeapon == "hlc_rifle_aku12") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["hlc_30Rnd_545x39_B_AK", 6];
	    };
	    ...
	    if (_randomWeapon == "hlc_rifle_ak47" OR _randomWeapon == "hlc_rifle_akm") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _uniform addMagazineCargoGlobal ["hlc_30Rnd_762x39_b_ak", 6];
	    };    
    };
    ...
    if (isClass(configFile >> "CfgPatches" >> "hlc_wp_AR15")) then 
    {
	    if (_randomWeapon == "hlc_rifle_honeybadger") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["29rnd_300BLK_STANAG", 6];
	    };
	    ...
	    if (_randomWeapon == "hlc_rifle_RU5562" OR _randomWeapon == "hlc_rifle_RU556" OR _randomWeapon == "hlc_rifle_bcmjack" OR _randomWeapon == "hlc_rifle_M4" OR _randomWeapon == "hlc_rifle_CQBR") then 
	    {
            ...
            _unit addWeaponGlobal _randomWeapon;	    	  
	        _unit addPrimaryWeaponItem "acc_flashlight";
	        _uniform addMagazineCargoGlobal ["hlc_30rnd_556x45_EPR", 6];
	    };
    ...
    if (pht6_parameter_enemyFAK > 0) 			then {_unit addItem "FirstAidKit";    				};
    if (pht6_parameter_enemyThrowableGrenades > 0) 		then {_unit addMagazineGlobal "HandGrenade";		};
    if (pht6_parameter_enemyThrowableMiniGrenades > 0) 	then {_unit addMagazineGlobal "MiniGrenade";		};
    if (pht6_parameter_enemyThrowableSmokeGrenades > 0) 	then {_unit addMagazineGlobal "SmokeShell";			};
    if (pht6_parameter_enemyThrowableChemLights > 0) 		then {_unit addMagazineGlobal "Chemlight_yellow";	};
    
    if (pht6_parameter_enemyFAK > 0) then {
        _uniform addItemCargoGlobal ["FirstAidKit", pht6_parameter_enemyFAK-1];
    };
    if (pht6_parameter_enemyThrowableGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["HandGrenade", pht6_parameter_enemyThrowableGrenades-1];
    };
    if (pht6_parameter_enemyThrowableMiniGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["MiniGrenade", pht6_parameter_enemyThrowableMiniGrenades-1];
    };
    if (pht6_parameter_enemyThrowableSmokeGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["SmokeShell", pht6_parameter_enemyThrowableSmokeGrenades-1];
    };
    if (pht6_parameter_enemyThrowableChemLights > 0) then {
        _uniform addMagazineCargoGlobal ["Chemlight_yellow", pht6_parameter_enemyThrowableChemLights-1];
    };
