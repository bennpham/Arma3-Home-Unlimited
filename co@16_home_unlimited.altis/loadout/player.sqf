...
if (!isNull _unit) then {
    ...
    if (pht6_parameter_playerFAK > 0) then {
        _uniform addItemCargoGlobal ["FirstAidKit", pht6_parameter_playerFAK-1];
    };
    if (pht6_parameter_playerThrowableGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["HandGrenade", pht6_parameter_playerThrowableGrenades-1];
    };
    if (pht6_parameter_playerThrowableMiniGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["MiniGrenade", pht6_parameter_playerThrowableMiniGrenades-1];
    };
    if (pht6_parameter_playerThrowableSmokeGrenades > 0) then {
        _uniform addMagazineCargoGlobal ["SmokeShell", pht6_parameter_playerThrowableSmokeGrenades-1];
    };
    if (pht6_parameter_playerThrowableChemLights > 0) then {
        _uniform addMagazineCargoGlobal ["Chemlight_yellow", pht6_parameter_playerThrowableChemLights-1];
    };
